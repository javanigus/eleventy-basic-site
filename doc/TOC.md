...
* [Usage](/doc/usage/) — Overview of the project contents.
* [FAQ](/doc/faq/) — Frequently asked questions along with their answers.

## HTML5 Boilerplate core

* [HTML](/doc/html/) — Guide to the default HTML.
* [CSS](/doc/css/) — Guide to the default CSS.
* [JavaScript](/doc/js/) — Guide to the default JavaScript.
* [Everything else](/doc/misc/).

## Development

* [Extending and customizing HTML5 Boilerplate](/doc/extend/) — Going further with
  the boilerplate.
